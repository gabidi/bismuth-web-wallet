                    ...
                    <v-toolbar id="addressSearchToolbar">
                        ...
                        <v-toolbar-items>
                            ...
                            <v-menu offset-x left bottom>
                                ...
                                <v-list dense>
                                    <v-list-tile v-if="addressTxnList.length" @click="()=>addressExtraInfo.show = !addressExtraInfo.show">
                                        <v-list-tile-avatar>
                                            <v-icon>{{(addressExtraInfo.show)? 'fa-chevron-up' : 'fa-chevron-down'}}</v-icon>
                                        </v-list-tile-avatar>
                                        <v-list-tile-title>
